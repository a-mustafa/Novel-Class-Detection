...
public class Minstance extends Instance{
    ...
    public boolean tfn = false, tfp = false;/*Ahmad*/
    public boolean isZeroAttack = false;                 //is it a novel class and attack instance during comit?  /*Ahmad*/
    public double predictedClass = -1.0;     // /*Ahmad*/
    public boolean cfp = false, cfn = false, ctp = false, ctn = false;   // /*Ahmad*/
