...
public class Constants {
    ...
    public static int MAXSLIDINGWINDOWSIZE = 3000;
    public static double SENSITIVITY = 0.001;
    public static double GAMMA = 0.5;
    public static double RELAXATION = SENSITIVITY; 
    public static String AEparam = "";
